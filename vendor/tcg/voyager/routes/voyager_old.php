...
Route::group(['as' => 'voyager.'], function () {
    ...
    Route::group(['middleware' => 'admin.user'], function () use ($namespacePrefix) {
        ...
        Route::get('profile', ['uses' => $namespacePrefix.'VoyagerCnotroller@profile', 'as' => 'profile']);
        ...
        Route::group([
            ...
            Route::get('/', ['uses' => $namespacePrefix.'EventController@index',              'as' => 'index']);
            Route::get('/create', ['uses' => $namespacePrefix.'EventController@create',              'as' => 'create']);
