			...
			<div class="container">
				...
				<div class="col_full nobottommargin clearfix">						
								...
								<div class="col_one_third">
									<div class="ipost clearfix">
										<div class="entry-image">
											<a href="#"><img class="image_fade" src="{{asset('images/magazine/thumb/11.jpg')}}" alt="Image" style="opacity: 1;"></a>
										</div>
								...
								<div class="col_one_third">
									<div class="ipost clearfix">
										<div class="entry-image">
											<a href="#"><img class="image_fade" src="{{asset('images/magazine/thumb/16.jpg')}}" alt="Image" style="opacity: 1;"></a>
										</div>
										<div class="entry-title">
								...
								<div class="col_one_third col_last">
									<div class="ipost clearfix">
										<div class="entry-image">
											<a href="#"><img class="image_fade" src="{{asset('images/magazine/thumb/13.jpg')}}" alt="Image" style="opacity: 1;"></a>
										</div>
										<div class="entry-title">
