			...
			<div class="container clearfix">
							...
							<div class="pricing pricing--jinpa">
								...
								<div class="pricing--item two-clm">
											...
											<a href="{{route('frontend.resform',$plan->id)}}"><button class="pricing--action">Choose plan</button></a>
								</div>
								@endforeach
							</div>
							@else
							<h2 class="pricing-section--title center">Hot Desk Memberships</h2>
									...
									<div class="pricing pricing--jinpa">
										...
										<div class="pricing--item">
											...
											<div class="pricing--price"><span class="pricing--currency">$</span>{{$plan->price}}</div>					
											{!!$plan->detail!!}
											<a href="{{route('frontend.resform',$plan->id)}}"><button class="pricing--action">reserve</button></a>
										</div>
										@endforeach
									</div>
									@endif
