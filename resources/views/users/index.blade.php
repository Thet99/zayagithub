		...
		<div class="card testimonial-card">
		    ...
		    <div class="row">
		        ...
		        <div class="col-md-6">
		            <!-- Material input -->
					 <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
		                <input class="mdl-textfield__input" type="text" value="{{Auth::user()->fname}}" readonly id="sample3">
		        ...
		        <div class="col-md-6">
		            <!-- Material input -->
		            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
		                <input class="mdl-textfield__input" type="text" value="{{Auth::user()->lname}}" readonly id="lname">
		    ...
		    <div class="row">
		        ...
		        <div class="col-md-4">
		            ...
		            <!-- Material input -->
		            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
		                <input class="mdl-textfield__input" type="text" value="{{Auth::user()->company}}" readonly id="cname">
		        ...
		        <div class="col-md-4">
		            ...
		            <!-- Material input -->
		            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
		                <input class="mdl-textfield__input" type="text" value="{{Auth::user()->email}}" readonlyid="email">
		        ...
		        <div class="col-md-4">
		            ...
		            <!-- Material input -->
		            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
		                <input class="mdl-textfield__input" type="text" value="{{Auth::user()->mobile}}" readonly id="ph">
