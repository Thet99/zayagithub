				...
				<div class="footer-widgets-wrap clearfix">
					...
					<div class="col-md-6">
						...
						<div class="widget quick-contact-widget clearfix">
							...
							<form id="quick-contact-form" name="quick-contact-form" action="<?php echo e(route('send_toadmin')); ?>" method="post" class="quick-contact-form nobottommargin">
				...
				<div class="container clearfix">
					...
					<div class="col_full nobottommargin center">
						<div class="copyrights-menu copyright-links clearfix">
							...
							/<a href="<?php echo e(route('frontend.about')); ?>">About</a>							
							/<a href="<?php echo e(route('frontend.terms')); ?>">Terms & Conditions</a>
	...
	<script type="text/javascript" src="<?php echo e(asset('css/material.js')); ?>"></script>
</body>
</html>