...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.17.47/css/bootstrap-datetimepicker-standalone.min.css.map" rel="stylesheet">
...
<?php endif; ?>
<input type="button" value="Click Me" onclick="create();" id="add">
</body>
</html>
