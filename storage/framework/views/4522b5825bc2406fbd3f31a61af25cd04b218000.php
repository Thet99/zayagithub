					...
					<div class="panel-body" style="border: 1px solid #efefef;">
						<form action="<?php echo e(route('login')); ?>" method="post">
						 ...
						 <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						    <input class="mdl-textfield__input" value="<?php echo e(old('email')); ?>"  type="text" id="Email">
						  ...
						  <div class="col_full nobottommargin">
								...
								<a href="href="<?php echo e(route('password.request')); ?>" class="fright">Forgot Password?</a>
						  </div>
						</form>		
					</div>
				</div>						
