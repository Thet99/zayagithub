...
<head>
    ...
    <style>
        body {
            background-image:url('<?php echo e(Voyager::image( Voyager::setting("admin.bg_image"), voyager_asset("images/bg_old.jpg") )); ?>');
            ...
            <div class="clearfix">
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        <?php $admin_logo_img = Voyager::setting('admin.icon_image', '/images/logo.png'); ?>
                        <?php if($admin_logo_img == ''): ?>
                         
                        <img class="img-responsive pull-left logo hidden-xs animated fadeIn" src="<?php echo e(voyager_asset('images/logo.png')); ?>" alt="Logo Icon">
                        <?php else: ?>
                        ...
                        <div class="copy animated fadeIn">
                            <h1><?php echo e(Voyager::setting('admin.title', 'ZAYAT')); ?></h1>
