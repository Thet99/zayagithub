				...
				<div class="clearfix">
					...
					<div class="col-md-4 dark col-padding">
						<div class="fbox-desc">
							<div class="heading-block fancy-title nobottomborder title-bottom-border">
								...
								<img class="image_fade" src="<?php echo e(asset('images/magazine/thumb/1.jpg')); ?>" alt="Image" style="opacity: 1; height: 200px;">
							...
							<a href="<?php echo e(route('frontend.location')); ?>" class="button button-small button-border button-rounded uppercase nomargin">Read More</a>
					...
					<div class="col-md-4 dark col-padding">
						<div class="fbox-desc">
							...
							<img src="<?php echo e(asset('images/event/2.jpg')); ?>" style="height: 200px;">
							...
							<a href="<?php echo e(route('frontend.community')); ?>" class="button button-small button-border button-rounded uppercase nomargin">Read More</a>
					...
					<div class="col-md-4 dark col-padding">
						<div class="fbox-desc">
							...
							<img src="<?php echo e(asset('images/event/7.jpg')); ?>" style="height: 200px;">
							...
							<a href="<?php echo e(route('frontend.events')); ?>" class="button button-small button-border button-rounded uppercase nomargin">Read More</a>
							<br>
							<!--For modern browsers-->
