...
<a href="<?php echo e(route('social.redirect', ['provider' => 'facebook'])); ?>"  class="btn btn-primary btn-block btn-social btn-facebook">
...
<a href="<?php echo e(route('social.redirect', ['provider' => 'google'])); ?>" class="btn btn-danger btn-block btn-social btn-facebook">
  ...
  <a href="<?php echo e(route('social.redirect', ['provider' => 'google'])); ?>" class="btn btn-info btn-block btn-social btn-facebook">
...
<form class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 button-group">       <button type="submit" class="btn btn-primary btn-lg" data-membership-id="" style="width:100%">Register</button><br>                            
                                    <div class="text-gary">
                                        <p>By registering, you agree to our <a href="<?php echo e(route('frontend.terms')); ?>" target="_blank">Terms & Conditons.</a></p>
                                    </div>
                                </div>
                            </div>
</form>
